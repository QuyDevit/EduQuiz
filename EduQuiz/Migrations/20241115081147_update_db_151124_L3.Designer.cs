...
namespace EduQuiz.Migrations
{
    ...
    [Migration("20241115081147_update_db_151124_L3")]
    partial class update_db_151124_L3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduQuiz.Models.EF.ChoiceSnapshot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduQuiz.Models.EF.EduQuizSnapshot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduQuiz.Models.EF.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduQuiz.Models.EF.Profile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ListEduQuizTop")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EduQuiz.Models.EF.QuestionSnapshot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduQuiz.Models.EF.QuizSession", b =>
                {
                    ...
                    b.Property<int>("TypeQuizSession")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduQuiz.Models.EF.QuizSessionQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduQuiz.Models.EF.ChoiceSnapshot", b =>
                {
                    b.HasOne("EduQuiz.Models.EF.QuestionSnapshot", "Question")
                        .WithMany("Choices")
                        .HasForeignKey("QuestionId");
            ...
            modelBuilder.Entity("EduQuiz.Models.EF.PlayerAnswer", b =>
                {
                    b.HasOne("EduQuiz.Models.EF.ChoiceSnapshot", "Choice")
                        .WithMany()
            ...
            modelBuilder.Entity("EduQuiz.Models.EF.QuestionSnapshot", b =>
                {
                    ...
                    b.HasOne("EduQuiz.Models.EF.EduQuizSnapshot", null)
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("EduQuiz.Models.EF.QuizSession", b =>
                {
                    ...
                    b.HasOne("EduQuiz.Models.EF.EduQuizSnapshot", "EduQuizSnapshot")
                        .WithMany()
                        .HasForeignKey("EduQuizSnapshotId");
